...
import uk.co.paulcowie.sunshine.data.WeatherContract;
import uk.co.paulcowie.sunshine.data.WeatherContract.WeatherEntry;
import uk.co.paulcowie.sunshine.data.WeatherDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    public void testInsertReadDb() {
        ...
        values.put(WeatherContract.LocationEntry.COLUMN_LOC_SETTING, testLocationSetting);
        ...
        values.put(WeatherContract.LocationEntry.COLUMN_LON, testLongitude);
        ...
        if (cursor.moveToFirst()) {
            ...
            int locationIndex = cursor.getColumnIndex(WeatherContract.LocationEntry.COLUMN_LOC_SETTING);
            String location = cursor.getString(locationIndex);

            int nameIndex = cursor.getColumnIndex((WeatherContract.LocationEntry.COLUMN_CITY_NAME));
            String name = cursor.getString(nameIndex);

            int latIndex = cursor.getColumnIndex((WeatherContract.LocationEntry.COLUMN_LAT));
            double latitude = cursor.getDouble(latIndex);

            int longIndex = cursor.getColumnIndex((WeatherContract.LocationEntry.COLUMN_LON));
